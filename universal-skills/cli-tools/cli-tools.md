---
name: cli-tools
description: Comprehensive guide for all CLI tools available in the C:\Dev environment (jq, yq, fd, rg, rga, bat, pandoc, uv, delta, dust, gh, repomix). Use when manipulating config files, searching for files or content, converting documents, managing Python environments, or packing repositories for AI analysis.
---
