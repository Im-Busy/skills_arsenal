---
name: deslop-zh
description: 去除中文写作中的 AI 腔调，让文本像人写的而非模型生成的。覆盖博客、技术文档、推文、发行说明、科学论文等场景。Hybrid invocation，适用于一般中文改写、润色、审稿和去 AI 味请求。英文去 AI 味见 deslop-en。Do NOT use for English output, code documentation, technical API references, or requests that explicitly name the manual stop-slop-zh alternative.
license: MIT
metadata:
  version: "1.0.0"
  ...
  sources: "https://github.com/hexiecs/talk-normal, https://github.com/ninehills/skills, https://zh.wikipedia.org/wiki/Wikipedia:AI生成文的特徵, https://github.com/hardikpandya/stop-slop, https://github.com/stephenturner/skill-deslop, https://tropes.fyi, https://github.com/coderjatin/anti-slop-writing"
---

## Related skills / Do NOT confuse with

- **stop-slop-zh**: Manual alternative used only when the user explicitly names
  or invokes it. General Chinese rewrite and de-slopping requests use
  `deslop-zh`.
- **stop-slop**: English only.
